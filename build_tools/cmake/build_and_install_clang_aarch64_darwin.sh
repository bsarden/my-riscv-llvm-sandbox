...
declare -a CMAKE_ARGS=(
  ...
  # Build clang with support for aarch64-darwin codegen.
  "-DLLVM_ENABLE_PROJECTS=${LLVM_ENABLE_PROJECTS:-clang}"
  "-DLLVM_TARGETS_TO_BUILD=${LLVM_TARGETS_TO_BUILD:-AArch64}"
  ...
  # "-DLLVM_RUNTIME_TARGETS=arm64"
  # Build new version of libc++ so that clang install finds it
  ...
  "-DLLVM_CCACHE_DIR=${LLVM_CCACHE_DIR:-~/.cache/ccache/llvm.aarch64-darwin}"
)
